...
namespace DataAccessTier
{
    ...
    {
        public static DTDrivingTest FindLastTest(int PersonID)
        {
            ...
            string Query = "SELECT top 1"
                          ...
                          + ",[ResultAddedByUserID]"
                          + ",[TestClassID]"
                       + "FROM[dbo].[DrivingTests]"
                       + " Order By [AppointmentDate] Asc"
                       + " Where [PersonID] = @PersonID";

            SqlCommand Command = new SqlCommand(Query, Connection);
            Command.Parameters.AddWithValue("@PersonID", PersonID);
            DTDrivingTest FindedTest = null;
        ...
        public static DTDrivingTest Find(int TestID)
        {
            SqlConnection Connection = new SqlConnection(DataAccessSettings.DataAccessString);
        ...
        public static DTDrivingTest FindByApplicationID(int ApplicationID)
        {
            SqlConnection Connection = new SqlConnection(DataAccessSettings.DataAccessString);
        ...
        public static bool IsExist(int TestID)
        {
            ...
            string Query = @"select top 1 isExist = 1 from [DrivingTests] where  TestID =  @TestID";
        ...
        public static bool IsPassed(int TestID)
        {
            ...
            string Query = @"select top 1 IsPassed = 1 from [DrivingTests] where  TestID =  @TestID and TestResult = 1";
        ...
        public static bool IsExistByApplicationID(int ApplicationID)
        {
            ...
            string Query = @"select top 1 isExist = 1 from [DrivingTests] where  TestApplicationID =  @ApplicationID";
        ...
        public static DateTime? GetAppointmentDate(int TestID)
        {
            ...
            string Query = @"select [AppointmentDate] from [DrivingTests] where  TestID =  @TestID";
...

        {
            ...
            string Query = "SELECT"
                  ...
                  + ",[ResultAddedByUserID]"
                  + ",[TestClassID]"
                    + " FROM[dbo].[DrivingTests] where [PersonID] = @PersonID";
        ...
        private static int? _AddNewTest(ref DTDrivingTest TestToAdd)
        {
            if (TestToAdd == null)
                return null;
            ...
            if (AccessApplicationData.CouldAttachTestOfTypeToApplication(TestToAdd.TestApplicationID, TestType.DrivingTest))
                return null;
           ...
           " SELECT SCOPE_IDENTITY();";
            ...
            if (TestToAdd.ResultAddedByUserID == null)
                ...
                Command.Parameters.AddWithValue("@TestClassID", TestToAdd.TestClass.ToDBValue());
        ...
        public static DTDrivingTest AddNewTest(int PersonID, DateTime AppointmentDate, decimal PaidFees,
        ...
        {
            DTDrivingTest NewLicense = new DTDrivingTest(-1, PersonID, AppointmentDate, PaidFees,
